...
const ExampleSlider: React.FC<ExampleSliderProps> = ({ label, exampleBefore, exampleAfter }) => {
    return (
        <>
            ...
            <ReactCompareSlider
                ...
                <div className='relative text-center w-[313px] sm:w-[440px] md:w-[313px]'>
                    <div className='bg-white/30 backdrop-blur rounded w-14 text-xs absolute top-4 left-4 py-0.5 sm:w-20 sm:text-sm md:w-14 md:text-xs'>Before</div>
                    <ReactCompareSliderImage className='rounded-t-lg' src={exampleBefore} alt={`Example of ${label} - Original Image`} />
                </div>
                }
                itemTwo={
                <div className='relative text-center'>
                    <div className='bg-white/30 backdrop-blur rounded w-14 text-xs absolute top-4 right-4 py-0.5 sm:w-20 sm:text-sm md:w-14 md:text-xs'>After</div>
